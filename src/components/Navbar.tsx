        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="px-1.5 py-0.2 rounded text-[9px] bg-emerald-600 text-white uppercase font-black">{currentBusiness.mode}</span>
